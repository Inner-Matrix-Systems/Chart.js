export default class TimeScale extends Scale {
    ...
    /**
       ...
       * @protected
       */
    protected initOffsets(timestamps: number[]): object;
    /**
    ...
    /**
       * @protected
       */
    protected getLabelTimestamps(): any[];
    /**
       * @param {number[]} values
       * @protected
       */
    protected normalize(values: number[]): any[];
}
export type Unit = import("../core/core.adapters").TimeUnit;
export type Interval = {
    common: boolean;
    size: number;
    steps?: number;
};
export type DateAdapter = import("../core/core.adapters").DateAdapter;
