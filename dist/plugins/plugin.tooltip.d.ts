export class Tooltip extends Element<import("../../types/basic").AnyObject, import("../../types/basic").AnyObject> {
    /**
    ...
    options: any;
    dataPoints: {
        chart: import("../core/core.controller").default;
        label: any;
        parsed: any;
        raw: any;
        formattedValue: any;
        ...
        dataIndex: number;
        datasetIndex: number;
        element: Element<import("../../types/basic").AnyObject, import("../../types/basic").AnyObject>;
    }[];
    title: any;
    beforeBody: any;
    body: any[];
...
export type Chart = import("../platform/platform.base").Chart;
export type ChartEvent = import("../../types").ChartEvent;
export type ActiveElement = import("../../types").ActiveElement;
export type InteractionItem = import("../core/core.interaction").InteractionItem;
...
import { noop } from "../helpers/helpers.core";
