export class Legend extends Element<import("../../types/basic").AnyObject, import("../../types/basic").AnyObject> {
    /**
    ...
    /**
       ...
       */
    private _fitRows;
    _fitCols(titleHeight: any, fontSize: any, boxWidth: any, itemHeight: any): any;
    adjustHitBoxes(): void;
