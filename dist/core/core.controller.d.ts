...
declare class Chart {
    static defaults: import("./core.defaults").Defaults;
    static instances: {};
    static overrides: any;
    static registry: import("./core.registry").Registry;
    static version: any;
    ...
    set options(arg: any);
    get options(): any;
    get registry(): import("./core.registry").Registry;
    /**
       * @private
       */
    private _initialize;
     ...
     * @param {import('./core.plugins').filterCallback} [filter] - Filtering function for limiting which plugins are notified
       ...
       */
    notifyPlugins(hook: string, args?: any, filter?: import('./core.plugins').filterCallback): boolean;
    /**
       * @private
       */
