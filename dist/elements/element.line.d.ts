export default class LineElement extends Element<import("../../types/basic").AnyObject, import("../../types/basic").AnyObject> {
    static id: string;
    /**
     * @type {any}
     */
    ...
    _path: any;
    _points: any;
    _segments: import("../helpers").Segment[];
    _decimated: boolean;
    ...
    set points(arg: any);
    get points(): any;
    get segments(): import("../helpers").Segment[];
    /**
...
export type PointElement = import("./element.point").default;
